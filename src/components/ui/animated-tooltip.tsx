      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative cursor-pointer !m-0 h-14 w-14 rounded-full border-2 border-white object-cover object-top 
            !p-0 transition duration-50 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
